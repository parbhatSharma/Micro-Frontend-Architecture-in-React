...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-DzDYQsO-.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-Bszc7Fmx.js', import.meta.url).href),import:true},'react-redux':{get:()=>()=>__federation_import(new URL('__federation_shared_react-redux-C1BNYqwq.js', import.meta.url).href),import:true},'@reduxjs/toolkit':{get:()=>()=>__federation_import(new URL('__federation_shared_@reduxjs/toolkit-COhDm-nB.js', import.meta.url).href),import:true}};
