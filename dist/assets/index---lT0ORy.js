...
import { r as reactDomExports } from './index-DMy-jj5-.js';
...
const remotesMap = {
'chatApp':{url:'http://localhost:5001/dist/assets/remoteEntry.js',format:'esm',from:'vite'},
  'emailApp':{url:'http://localhost:5002/dist/assets/remoteEntry.js',format:'esm',from:'vite'}
};
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'18.3.1':{get:()=>get(new URL('__federation_shared_react-DzDYQsO-.js', import.meta.url).href, remoteFrom), loaded:1}},'react-dom':{'18.3.1':{get:()=>get(new URL('__federation_shared_react-dom-Bszc7Fmx.js', import.meta.url).href, remoteFrom), loaded:1}},'react-redux':{'9.2.0':{get:()=>get(new URL('__federation_shared_react-redux-C1BNYqwq.js', import.meta.url).href, remoteFrom), loaded:1}},'@reduxjs/toolkit':{'2.5.1':{get:()=>get(new URL('__federation_shared_@reduxjs/toolkit-COhDm-nB.js', import.meta.url).href, remoteFrom), loaded:1}}
  ...
  reducers: {
    ...
    sendEmail: (state, action) => {
      state.emails.unshift({
        ...
        timestamp: (/* @__PURE__ */ new Date()).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit", hour12: true }),
        read: true
      });
...
await importShared('react-redux');
...
const Layout = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "bg-white shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between h-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-8 w-8 text-blue-600" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:ml-6 sm:flex sm:space-x-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "max-w-7xl mx-auto py-6 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
  ] });
};
...
const ChatApp = React.lazy(() => __federation_method_getRemote("chatApp" , "./App").then(module=>__federation_method_wrapDefault(module, true)));
const EmailApp = React.lazy(() => __federation_method_getRemote("emailApp" , "./App").then(module=>__federation_method_wrapDefault(module, true)));
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Provider, { store, children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, {}), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { index: true, element: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-[calc(100vh-4rem)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-gray-900 mb-4", children: "Welcome to the Micro-Frontend Demo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-600", children: "Choose an application from the navigation menu above" })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "chat/*",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-[calc(100vh-4rem)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600" }) }), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChatApp, {}) }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "email/*",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-[calc(100vh-4rem)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600" }) }), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmailApp, {}) }) })
      }
    )
  ] }) }) }) }) });
}
