...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-D6MfjgL2.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-CozviX5l.js', import.meta.url).href),import:true},'react-redux':{get:()=>()=>__federation_import(new URL('__federation_shared_react-redux-DkA9NjUE.js', import.meta.url).href),import:true},'@reduxjs/toolkit':{get:()=>()=>__federation_import(new URL('__federation_shared_@reduxjs/toolkit-DM6BHJaA.js', import.meta.url).href),import:true}};
